...
$entryid=mt_rand(100000000, 999999999);
 ...
 $query=mysqli_query($con,"insert into tblusers(EntryID,UserName,UserAddress,MobileNumber,Email,ComputerName,IDProof,Status) value('$entryid','$username','$uadd','$mobilenumber','$email','$cname','$idproof', 'Active')");
...
<body>
    ...
    echo $msg;
              ...
              {
              ?>    
              <option value="<?php echo $row['ID'];?>"><?php echo $row['ComputerName'];?>-(<?php echo $row['ComputerLocation'];?>)</option>
                  <?php } ?>  
                                                    </select></div>
                                                    </div>
                                                    <div class="col-12">
